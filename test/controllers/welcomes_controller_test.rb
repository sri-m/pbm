...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { confirm_password: @welcome.confirm_password, dob: @welcome.dob, email: @welcome.email, gender: @welcome.gender, name: @welcome.name, password: @welcome.password, phone: @welcome.phone }
    end
  ...
  test "should update welcome" do
    patch :update, id: @welcome, welcome: { confirm_password: @welcome.confirm_password, dob: @welcome.dob, email: @welcome.email, gender: @welcome.gender, name: @welcome.name, password: @welcome.password, phone: @welcome.phone }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
