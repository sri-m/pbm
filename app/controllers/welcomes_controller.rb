class WelcomesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @welcome.save
        format.html { redirect_to available_stocks_path, notice: '' }
        format.json { render :show, status: :created, location: @available_stocks }
      else
  ...
  private
    ...
    def welcome_params
      params.require(:welcome).permit(:name, :email, :phone, :dob, :gender, :password, :confirm_password)
    end
end
